...
describe CommentsController do
  # describe "POST #create" do
    ...
    #       comment_params = FactoryBot.attributes_for(:comment, user_id: @user.id, shop_id: @shop.id)
    #       sign_in @user
    #       expect {post :create, params: {comment: comment_params}}.to change(@user.comments, :count).by(1)
    #     end
    #   end
    ...
    #       comment_params = FactoryBot.attributes_for(:comment, user_id: @user.id, shop_id: @shop.id)
    #       sign_in @user
    #       expect{post :create, params: {comment: comment_params}}.to change(@user.comments, :count)
    #     end
    #   end
    # end
  ...
  describe "DELETE #destroy" do
    ...
    context "as an unauthenticated user" do
      ...
      it "does not delete a comment" do
        sign_in @user
        expect{delete :destroy, params: {id: @comment.id}}.to_not change(@other_user.comments, :count)
      end
